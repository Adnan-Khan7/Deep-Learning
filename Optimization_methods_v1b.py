...
def initialize_adam(parameters) :
    ...
    for l in range(L):
    ### START CODE HERE ### (approx. 4 lines)
        v["dW" + str(l+1)] = np.zeros(parameters["W" + str(1+1)].shape)
        v["db" + str(l+1)] = np.zeros(parameters["b" + str(1+1)].shape)
        s["dW" + str(l+1)] = np.zeros(parameters["W" + str(1+1)].shape)
        s["db" + str(l+1)] = np.zeros(parameters["b" + str(1+1)].shape)
    ### END CODE HERE ###
